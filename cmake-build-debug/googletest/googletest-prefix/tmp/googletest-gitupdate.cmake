...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref release-1.8.0
  WORKING_DIRECTORY "C:/Users/matt989253/Documents/git/GEN/heig-GEN-labo5-test2/cmake-build-debug/googletest/googletest-src"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 release-1.8.0
  WORKING_DIRECTORY "C:/Users/matt989253/Documents/git/GEN/heig-GEN-labo5-test2/cmake-build-debug/googletest/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/matt989253/Documents/git/GEN/heig-GEN-labo5-test2/cmake-build-debug/googletest/googletest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/matt989253/Documents/git/GEN/heig-GEN-labo5-test2/cmake-build-debug/googletest/googletest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
